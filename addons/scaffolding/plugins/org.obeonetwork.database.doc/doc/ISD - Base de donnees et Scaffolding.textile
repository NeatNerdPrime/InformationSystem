...
Cet outil permet d'initialiser un MPD à partir d'une base de donnée existante. Un assistant est accessible via le menu _File > Import … > Database > Import Database_.
